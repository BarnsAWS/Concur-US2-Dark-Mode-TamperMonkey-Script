// ==UserScript==
// @name         Concur US2 Dark Mode
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  High-contrast dark mode for us2.concursolutions.com (SAP Concur expense portal) — nuclear approach.
//               Color palette: AWS Cloudscape "Polaris Dark Mode" tokens v3.3.
// @author       BarnsAWS
// @match        https://us2.concursolutions.com/*
...
(function() {
    ...
    const SCRIPT_NAME = 'Concur US2 Dark Mode';
    const STYLE_ID = 'concur-us2-dark-mode-style';
